...
<html >
    ...
    <body>
            ...
            <div class="container">
                <div class="media-container-row">
                    <div class="title col-12 col-md-8">
                        <h2 class="align-center mbr-bold mbr-white pb-3 mbr-fonts-style display-5">FIXTURE</h2>
        ...
        <section class="map1 cid-qP0IZYcMam" id="map1-h">

            <?php 
            echo '<img id="imgfix" src="img/fixture/fixture_campeonato_teleton_pc.png?hash=' . filemtime("img/fixture/fixture_campeonato_teleton_pc.png") . '" alt="" />';
            echo '<img id="imgfixm" src="img/fixture/fixture_campeonato_teleton_mobile.png?hash=' . filemtime("img/fixture/fixture_campeonato_teleton_mobile.png") . '" alt=""/>';
?>
            <!--<div class="google-map"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1637.0997818509477!2d-55.998188727999086!3d-34.85121259653447!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x959f89e8ae60be37%3A0xe337d42e5d8c37c8!2sComplejo+Deportivo+Luis+Suarez!5e0!3m2!1ses!2suy!4v1531850044058" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe></div>-->
        </section>
